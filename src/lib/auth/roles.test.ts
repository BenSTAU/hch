...
//
// Vocabulaire des rôles. Ce que `hasRole` garantit tient en une phrase : la
// comparaison est EXACTE. C'est la seule ligne du produit qui sépare un compte
// ordinaire d'un administrateur, et elle n'a aucune dépendance.
